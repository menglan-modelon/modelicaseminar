...
model Charger_File "simple charger from file"
  extends .ModelicaSeminar.Seminar06.EVThermal.Interfaces.Charger;
...
equation
  ...
  connect(prescribedHeatFlow.Q_flow, controlBus.Q_charger) annotation (Line(
