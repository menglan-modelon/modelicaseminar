...
model Cabin_File "simple cabin from file"
  extends .ModelicaSeminar.Seminar06.EVThermal.Interfaces.Cabin;
...
equation
  ...
  connect(prescribedHeatFlow.Q_flow, controlBus.Q_cabin) annotation (Line(
