...
model Inverter_File "simple inverter from file"
  extends .ModelicaSeminar.Seminar06.EVThermal.Interfaces.Inverter;
  .LiquidCooling.Volumes.LiquidVolume volume(redeclare package Medium = Medium,      T_start=T_start)    annotation (Dialog, Placement(transformation(extent={{-10,-10},{10,10}})));
...
equation
  ...
  connect(prescribedHeatFlow.Q_flow, controlBus.Q_inverter) annotation (
