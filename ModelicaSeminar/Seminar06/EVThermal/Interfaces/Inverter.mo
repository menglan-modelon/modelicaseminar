...
partial model Inverter "inverter model interface"
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
        ...
        Line(
          points={{-4,-30},{-2,-28},{4,-26},{8,-26},{14,-28},{18,-32},{24,-34},
              {28,-34},{34,-32},{36,-30}},
          color={0,0,0},
          visible=not hide_component_icon),
        Line(
          points={{-4,-40},{-2,-38},{4,-36},{8,-36},{14,-38},{18,-42},{24,-44},
              {28,-44},{34,-42},{36,-40}},
          color={0,0,0},
          visible=not hide_component_icon),
        Line(
          points={{-4,-50},{-2,-48},{4,-46},{8,-46},{14,-48},{18,-52},{24,-54},
              {28,-54},{34,-52},{36,-50}},
          color={0,0,0},
          visible=not hide_component_icon),
